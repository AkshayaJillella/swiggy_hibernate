...
public class akshayacontroller {
	...
	private static void getbyid() {
		...
		System.out.println("Enter id:");
		 ...
		 akshaya a = s.get(akshaya.class, id);
		 if(a!=null) {
	...
	private static void getall() {
		...
		Session s = sf.openSession();
		Transaction t = s.beginTransaction();
		List<akshaya> li = s.createQuery("from akshaya", akshaya.class).list();
		t.commit();
